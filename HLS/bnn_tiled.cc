...
#pragma HLS INTERFACE m_axi depth=2 port=output offset=slave bundle=RESULT
...
//	cout << "msb_fmap[0]" << msb_fmap[0][0][0] << endl;
    ...
    for (int c_out = 0; c_out < out_channels/OUT_CHANNEL_PARALLELISM; c_out ++){
        int c_in = 0;
//    	cout << conv_weight_all[conv_weight_ptr][0][2][2] << endl;
        pg_conv3x3_tile(
...
//    			for (int col = 0; col < 32; col ++) {
//    				//#pragma HLS PIPELINE
//    				cout << "out: " << out_buf_0[c][row][col] << endl;
//					std::cout << "Starting sleep..." << std::endl;
//					std::this_thread::sleep_for(std::chrono::seconds(2));  // Ë¯Ãß2Ãë
...
//				layer1_0_rprelu1_prelu_weight_fix[c_out],
				layer1_0_rprelu1_weight_fix[c_out],
...
//				layer1_0_rprelu2_prelu_weight_fix[c_out],
				layer1_0_rprelu2_weight_fix[c_out],
...
//				layer1_1_rprelu1_prelu_weight_fix[c_out],
				layer1_1_rprelu1_weight_fix[c_out],
...
//				layer1_1_rprelu2_prelu_weight_fix[c_out],
				layer1_1_rprelu2_weight_fix[c_out],
...
//				layer1_2_rprelu1_prelu_weight_fix[c_out],
				layer1_2_rprelu1_weight_fix[c_out],
...
//				layer1_2_rprelu2_prelu_weight_fix[c_out],
				layer1_2_rprelu2_weight_fix[c_out],
	...
	FIX_32_10 pool_out_buf[32];
	FIX_32_10 linear_out_buf[2];
	pool_out_buf_init:
	for (int i = 0; i < 32; i ++){
		pool_out_buf[i] = 0;
	}
