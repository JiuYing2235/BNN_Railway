...
parser.add_argument('--num_epoch', '-e', type=int, default=200)
...
def load_cifar10():
    ...
    trainset = RailwaySet(root=args.data_dir, train=True, transform=transform_train)
    ...
    classes = ('Defection', 'Non defection')
...
def train_model(trainloader, testloader, net, optimizer, scheduler, start_epoch, device):
    ...
    # 打开文件来保存标签
    label_file_path = 'training_labels.txt'
